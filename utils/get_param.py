...
def params(load=None):
    ...
    if load is not None:
        ...
        #parser.add_argument('--dataset_dir', default="./grid_example/", type=str, help='load latest version for training (if True: leave load_date_time and load_index None. default: False)')
        # #endregion
