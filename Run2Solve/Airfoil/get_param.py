...
def params(load=None):
    ...
    if load is not None:
        ...
        parser.add_argument('--n_epochs', default=3000, type=int, help='number of time steps to simulate (like endTime/dt)')
        ...
        parser.add_argument('--lr', default=5e-4, type=float, help='learning rate of optimizer (default: 0.0005)')
        ...
        parser.add_argument('--max_inner_steps', default=2000, type=int, help='max iterations per time step (like fvSolution maxIter)')
        ...
        parser.add_argument('--dataset_dir', default="./grid_example/NACA0012", type=str, help='load latest version for training (if True: leave load_date_time and load_index None. default: False)')
        # #endregion
