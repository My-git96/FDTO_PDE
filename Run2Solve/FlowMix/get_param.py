...
def params(load=None):
    ...
    if load is not None:
        ...
        parser.add_argument('--n_epochs', default=256, type=int, help='number of time steps to simulate (like endTime/dt)')
        ...
        parser.add_argument('--dataset_dir', default="./grid_example/FlowMix", type=str, help='load latest version for training (if True: leave load_date_time and load_index None. default: False)')
        # #endregion
