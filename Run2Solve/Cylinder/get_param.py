...
def params(load=None):
    ...
    if load is not None:
        ...
        parser.add_argument('--lr', default=5e-5, type=float, help='learning rate of optimizer (default: 0.0005)')
        ...
        parser.add_argument('--dataset_dir', default="./grid_example/Cylinder", type=str, help='load latest version for training (if True: leave load_date_time and load_index None. default: False)')
        # #endregion
