...
def params(load=None):
    ...
    if load is not None:
        ...
        parser.add_argument('--n_epochs', default=100, type=int, help='number of time steps to simulate (like endTime/dt)')
        ...
        parser.add_argument('--average_sequence_length', default=100, type=int, help='average_sequence_length')
        ...
        parser.add_argument('--print_interval', default=10, type=int, help='print residuals every N inner iterations')
        ...
        parser.add_argument('--dataset_dir', default="./grid_example/Diffusion", type=str, help='load latest version for training (if True: leave load_date_time and load_index None. default: False)')
        # #endregion
